            ...
            <div class="row">
                <div style="margin-top: 1%" class="col-12">
                    ...
                    <div id = 'successAlert' class="hidden alert alert-success alert-dismissible">
                        <button type="button" class="close" aria-hidden="true">×</button>
                        <h5><i class="icon fas fa-check"></i> {{__('Клиент успешно создан')}}</h5>
                        Success alert preview. This alert is dismissable.
                    </div>
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">{{__('Создаение клиента')}}</h3>
                        </div>
                        <form id='userFrom' action="{{route('client.store')}}">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">{{__('Пароль')}}</label>
